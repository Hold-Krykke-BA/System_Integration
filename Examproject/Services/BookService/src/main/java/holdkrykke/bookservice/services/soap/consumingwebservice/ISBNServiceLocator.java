...
public class ISBNServiceLocator extends org.apache.axis.client.Service implements holdkrykke.bookservice.services.soap.consumingwebservice.ISBNService {
 ...
 */
    ...
    public holdkrykke.bookservice.services.soap.consumingwebservice.ISBNServiceSoapType getISBNServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            holdkrykke.bookservice.services.soap.consumingwebservice.ISBNServiceSoapBindingStub _stub = new holdkrykke.bookservice.services.soap.consumingwebservice.ISBNServiceSoapBindingStub(portAddress, this);
    ...
    public holdkrykke.bookservice.services.soap.consumingwebservice.ISBNServiceSoapType getISBNServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            holdkrykke.bookservice.services.soap.consumingwebservice.ISBNServiceSoapBinding12Stub _stub = new holdkrykke.bookservice.services.soap.consumingwebservice.ISBNServiceSoapBinding12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (holdkrykke.bookservice.services.soap.consumingwebservice.ISBNServiceSoapType.class.isAssignableFrom(serviceEndpointInterface)) {
                holdkrykke.bookservice.services.soap.consumingwebservice.ISBNServiceSoapBindingStub _stub = new holdkrykke.bookservice.services.soap.consumingwebservice.ISBNServiceSoapBindingStub(new java.net.URL(ISBNServiceSoap_address), this);
                _stub.setPortName(getISBNServiceSoapWSDDServiceName());
                return _stub;
            }
            if (holdkrykke.bookservice.services.soap.consumingwebservice.ISBNServiceSoapType.class.isAssignableFrom(serviceEndpointInterface)) {
                holdkrykke.bookservice.services.soap.consumingwebservice.ISBNServiceSoapBinding12Stub _stub = new holdkrykke.bookservice.services.soap.consumingwebservice.ISBNServiceSoapBinding12Stub(new java.net.URL(ISBNServiceSoap12_address), this);
                _stub.setPortName(getISBNServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
