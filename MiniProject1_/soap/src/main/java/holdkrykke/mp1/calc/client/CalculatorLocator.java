...
public class CalculatorLocator extends org.apache.axis.client.Service implements holdkrykke.mp1.calc.client.Calculator {
    ...
    public holdkrykke.mp1.calc.client.CalculatorSoap_PortType getCalculatorSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public holdkrykke.mp1.calc.client.CalculatorSoap_PortType getCalculatorSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            holdkrykke.mp1.calc.client.CalculatorSoap12Stub _stub = new holdkrykke.mp1.calc.client.CalculatorSoap12Stub(portAddress, this);
    ...
    public holdkrykke.mp1.calc.client.CalculatorSoap_PortType getCalculatorSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public holdkrykke.mp1.calc.client.CalculatorSoap_PortType getCalculatorSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            holdkrykke.mp1.calc.client.CalculatorSoap_BindingStub _stub = new holdkrykke.mp1.calc.client.CalculatorSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (holdkrykke.mp1.calc.client.CalculatorSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                holdkrykke.mp1.calc.client.CalculatorSoap12Stub _stub = new holdkrykke.mp1.calc.client.CalculatorSoap12Stub(new java.net.URL(CalculatorSoap12_address), this);
                _stub.setPortName(getCalculatorSoap12WSDDServiceName());
                return _stub;
            }
            if (holdkrykke.mp1.calc.client.CalculatorSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                holdkrykke.mp1.calc.client.CalculatorSoap_BindingStub _stub = new holdkrykke.mp1.calc.client.CalculatorSoap_BindingStub(new java.net.URL(CalculatorSoap_address), this);
                _stub.setPortName(getCalculatorSoapWSDDServiceName());
                return _stub;
            }
        }
