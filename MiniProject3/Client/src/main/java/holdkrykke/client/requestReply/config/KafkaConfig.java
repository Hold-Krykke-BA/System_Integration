...
public class KafkaConfig {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "loanapptest2"); // change here to break forever loop
        return props;
    }
    ...
    public ConsumerFactory<String, LoanApplicant> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(consumerConfigs(),new StringDeserializer(),new JsonDeserializer<>(LoanApplicant.class));
    }
